...
public class AulaPraticaPK implements Serializable {
    ...
    public AulaPraticaPK(String alunoCpfAluno, String professorCpfProfessor, Date dataAula) {
    ...
    public String toString() {
        return "Entidades.AulaPraticaPK[ alunoCpfAluno=" + alunoCpfAluno + ", professorCpfProfessor=" + professorCpfProfessor + ", dataAula=" + dataAula + " ]";
    }
