 ...
 * @author Asus
 */
@WebServlet(name = "CadastroTipoVeiculo", urlPatterns = {"/cadTipoVeiculo"})
public class CadastroTipoVeiculoServlet extends HttpServlet {
...
//            p.setIdTipoVeiculo(id);
            ...
            response.sendRedirect(request.getContextPath() + "/paginas/tipoVeiculoCad.jsp");
        }
    }
